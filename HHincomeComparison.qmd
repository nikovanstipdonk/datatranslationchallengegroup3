...
counts_fin <- data_finance_finc%>%
  group_by(indname, covid, STATECENSUS, date)%>%
...
etable(fin_reg_high, fin_reg_high_controlled) 
etable(info_reg_high, info_reg_high_controlled)
...
etable(fin_reg_mid, fin_reg_mid_controlled) 
etable(info_reg_mid, info_reg_mid_controlled)
```
...
info_reg_low <- feols(no_low ~ covid + indname + covid * indname, data = counts_info)
info_reg_low_controlled <- feols(no_low ~ covid + indname + covid * indname| STATECENSUS, data = counts_info)
etable(fin_reg_low, fin_reg_low_controlled) 
etable(info_reg_low, info_reg_low_controlled)
```
